  ...
  render: () => {
    ...
    return (
      <div className="sb-column sb-width-300 sb-gap-16">
        ...
        <Text>normalizedValues: [{parsed.normalizedValues[0]}, {parsed.normalizedValues[1]}]</Text>
        <Text>formattedValues: ["{parsed.formattedValues[0]}", "{parsed.formattedValues[1]}"]</Text>
      </div>
    )
  },
}
