...
const meta: Meta<typeof TimePicker> = {
  ...
  parameters: {
    docs: {
      description: {
        component: 'A styled wrapper around the [react-time-picker](https://github.com/wojtekmaj/react-time-picker) component.',
      },
    },
  },
  tags: ['autodocs'],
  argTypes: {
    ...
    maxWidth: {
      control: { type: 'number' },
      description: 'Maximum width of the TimePicker (excluding label). Only applicable when variant is `list`.',
      table: {
        type: {
