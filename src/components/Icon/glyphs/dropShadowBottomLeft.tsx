...
export const dropShadowBottomLeft = ({ variant, size }: GlyphProps) => {
  ...
  switch (combination) {
    ...
    default:
      throw new Error(`dropShadowBottomLeft icon error: Unsupported combination size=${size}, variant=${variant}`)
  }
}
