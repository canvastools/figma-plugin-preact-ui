...
export const dropShadowBottomRight = ({ variant, size }: GlyphProps) => {
  ...
  switch (combination) {
    ...
    default:
      throw new Error(`dropShadowBottomRight icon error: Unsupported combination size=${size}, variant=${variant}`)
  }
}
