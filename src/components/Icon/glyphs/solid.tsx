...
export const solid = ({ variant }: GlyphProps) => {
  ...
  switch (combination) {
    case 'downscaled':
      return (
        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
          <rect x="6" y="6" width="4" height="4" fill="currentColor" fill-opacity="0.3" />
          <path
    ...
    case 'default':
      return (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <rect x="9" y="9" width="6" height="6" fill="currentColor" fill-opacity="0.3" />
          <path
    ...
    case 'upscaled':
      return (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <rect x="8" y="8" width="8" height="8" fill="currentColor" fill-opacity="0.3" />
          <path
    ...
    default:
      throw new Error(`solid icon error: Unsupported combination variant=${variant}`)
  }
}
