...
export const innerShadowBottomRight = ({ variant, size }: GlyphProps) => {
  ...
  switch (combination) {
    case '16_default':
      return (
        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M12 12H10L4 12V10H9C9.55228 10 10 9.55228 10 9V4H12L12 12Z" fill="currentColor" fill-opacity="0.3" />
          <path
    ...
    case '24_default':
      return (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M17 17H15H7V15L14 15C14.5523 15 15 14.5523 15 14L15 7H17V17Z" fill="currentColor" fill-opacity="0.3" />
          <path
    ...
    case '24_upscaled':
      return (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M19 19H17H5V17H16C16.5523 17 17 16.5523 17 16V5H19V19Z" fill="currentColor" fill-opacity="0.3" />
          <path
    ...
    default:
      throw new Error(`innerShadowBottomRight icon error: Unsupported combination size=${size}, variant=${variant}`)
  }
}
