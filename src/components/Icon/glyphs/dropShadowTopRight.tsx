...
export const dropShadowTopRight = ({ variant, size }: GlyphProps) => {
  ...
  switch (combination) {
    ...
    default:
      throw new Error(`dropShadowTopRight icon error: Unsupported combination size=${size}, variant=${variant}`)
  }
}
