...
export const fillStroke = ({ variant }: GlyphProps) => {
  ...
  switch (combination) {
    ...
    case 'upscaled':
      return (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M19 19H5V5H19V19ZM8 8V16H16V8H8Z" fill="currentColor" fill-opacity="0.3" />
          <path
    ...
    default:
      throw new Error(`fillStroke icon error: Unsupported combination variant=${variant}`)
  }
}
