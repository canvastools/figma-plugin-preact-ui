...
const meta: Meta<typeof Icon> = {
  ...
  argTypes: {
    ...
    glyph: {
      ...
      description: "Any library <a href='#glyphs'>glyph</a> to display as a child.",
      table: {
        type: {
    ...
    intentModifier: {
      control: { type: 'radio' },
      options: ['default', 'secondary', 'tertiary', 'brand', 'danger', 'warning', 'success'],
    ...
    children: {
      ...
      description: 'The SVG icon to display as a child if a custom glyph is required.',
      table: {
        type: {
          summary: 'preact.ComponentChildren',
        },
