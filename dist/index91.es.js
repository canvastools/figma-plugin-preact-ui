...
//#region src/components/Icon/glyphs/innerShadowBottom.tsx
var t = ({ variant: t }) => {
	switch (t) {
		...
		default: throw Error(`innerShadowBottom icon error: Unsupported combination variant=${t}`);
	}
};
//#endregion
export { t as innerShadowBottom };
