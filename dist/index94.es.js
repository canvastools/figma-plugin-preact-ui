...
//#region src/components/Icon/glyphs/innerShadowRight.tsx
var t = ({ variant: t }) => {
	switch (t) {
		...
		default: throw Error(`innerShadowRight icon error: Unsupported combination variant=${t}`);
	}
};
//#endregion
export { t as innerShadowRight };
