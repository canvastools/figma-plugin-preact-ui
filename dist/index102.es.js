...
//#region src/components/Icon/glyphs/fillStroke.tsx
var t = ({ variant: t }) => {
	switch (t) {
		...
		case "upscaled": return /* @__PURE__ */ e("svg", {
			...
			xmlns: "http://www.w3.org/2000/svg",
			children: [/* @__PURE__ */ e("path", {
				d: "M19 19H5V5H19V19ZM8 8V16H16V8H8Z",
				fill: "currentColor",
				"fill-opacity": "0.3"
			}), /* @__PURE__ */ e("path", {
		...
		default: throw Error(`fillStroke icon error: Unsupported combination variant=${t}`);
	}
};
//#endregion
export { t as fillStroke };
