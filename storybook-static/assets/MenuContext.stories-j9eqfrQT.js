import{n as e}from"./rolldown-runtime-DAXXjFlN.js";import{C as t,P as n,S as r,j as i,v as a,w as o}from"./compat.module-BiyPQZFw.js";import{n as s,t as c}from"./jsxRuntime.module-XYsEgyrh.js";import{t as l}from"./Text-Dx8we2OT.js";import{$n as u,B as d,Jt as f,Kt as p,Xt as m,Yt as h,qn as g,t as _}from"./src-fsSRAyCS.js";var v,y=e((()=>{o(),_(),h(),c(),v={parameters:{controls:{disable:!0},viewport:{defaultViewport:`large`},docs:{source:{code:`
const MenuContent = () => {
...
`}}},render:()=>{let e=a(null),[t,n]=r(!1);return s(`div`,{className:`sb-column sb-width-full sb-gap-40`,children:[s(g,{ref:e,onClick:()=>n(!0),children:`Open Menu`}),s(f,{triggerRef:e,open:t,setOpen:n,children:s(()=>{let t=m();return t?s(u,{anchorRef:e,open:t.open,placement:`bottom-left`,offsetY:4,offsetEdge:16,onClose:()=>t.setOpen(!1),children:s(p,{children:[s(d,{id:`action-1`,focused:t.focusedItemId===`action-1`,children:`Action 1`}),s(d,{id:`action-2`,focused:t.focusedItemId===`action-2`,children:`Action 2`}),s(d,{id:`action-3`,focused:t.focusedItemId===`action-3`,children:`Action 3`})]})}):null},{})})]})}}})),b,x=e((()=>{n(),o(),_(),h(),c(),b={parameters:{controls:{disable:!0},viewport:{defaultViewport:`large`},docs:{description:{story:`Custom items can be created using the useMenuContext hook to register the item and access the context for managing its states.<br/>It requires a custom CSS styling to be applied as well.`},source:{code:`
...
`}}},render:e=>{let[t,n]=r(e.open),i=a(null);return s(`div`,{className:`sb-column sb-width-full`,children:[s(g,{ref:i,onClick:()=>{n(!0)},children:`Open Menu`}),s(f,{triggerRef:i,anchorRef:i,open:t,setOpen:n,children:s(()=>{let e=m();return e?s(u,{anchorRef:e?.anchorRef,open:e.open,placement:`bottom-left`,offsetY:4,offsetEdge:16,onClose:()=>e.setOpen(!1),children:s(p,{children:[s(d,{id:`action-1`,onClick:()=>e.setOpen(!1),focused:e.focusedItemId===`action-1`,children:`Action 1`}),s(d,{id:`action-2`,onClick:()=>e.setOpen(!1),focused:e.focusedItemId===`action-2`,children:`Action 2`}),s(d,{id:`action-3`,onClick:()=>e.setOpen(!1),focused:e.focusedItemId===`action-3`,children:`Action 3`})]})}):null},{})})]})}},w=v,T=b,C.parameters={...C.parameters,docs:{...C.parameters?.docs,source:{originalSource:`{
  args: {
    open: false
  },
  parameters: {
