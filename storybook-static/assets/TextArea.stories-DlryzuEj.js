import{d as g,A as k,F as We,_ as j,y as q,u as t}from"./hooks.module-CGIakYml.js";import{f as v}from"./index-BWINGljf.js";import{k as $e}from"./preact.module-C06nO-nz.js";import{t as Be,b as Oe}from"./typedForwardRef-BtG8EZfd.js";import{T as be}from"./Text-9aeIDhQ2.js";import{T as Ye,a as Ge}from"./TooltipContext-DJAjWLpJ.js";import"./compat.module-DSB5hssq.js";import"./TooltipContainer-BVa1RtHA.js";const W=24;function I(n,s,r){return Math.min(r,Math.max(s,Math.round(n)))}function U(n){const s=getComputedStyle(n),r=parseFloat(s.minHeight),c=Number.isFinite(r)&&r>0?r:W,h=parseFloat(s.maxHeight),i=Number.isFinite(h)?Math.max(c,h):Number.MAX_SAFE_INTEGER;return{minPx:c,maxPx:i}}const Ke=({id:n,className:s,variant:r="default",label:c,placeholder:h,value:i,defaultValue:xe,error:ve=!1,disabled:f=!1,minLength:we=0,maxLength:Te,tooltip:$,autoFocus:B=!1,maxWidth:y,minHeight:d,maxHeight:u,resize:l,onValueChange:L,onBlur:N,onFocus:S,onKeyDown:E,...Ve},Pe)=>{const b=i!==void 0,[O,Ce]=g(()=>xe??""),[Ae,Y]=g(!1),[He,_]=g(!!(i??O??"")),[Le,G]=g(W),F=k(null),p=k(null),R=k(null);We(Pe,()=>F.current,[]);const K=b?i??"":O,Ne=l!=="y";j(()=>{if(l!=="y"||!p.current)return;const{minPx:e,maxPx:a}=U(p.current);G(m=>I(m,e,a))},[l,d,u]),j(()=>{const e=R.current,a=p.current;if(!e||!a)return;if(l==="y"){e.style.removeProperty("height");return}e.style.height="0px";const{minPx:m,maxPx:D}=U(a),M=I(e.scrollHeight,m,D);e.style.height=`${M}px`},[l,u,d,K]),q(()=>{if(!B)return;const e=window.setTimeout(()=>{var a;(a=R.current)==null||a.focus()},25);return()=>clearTimeout(e)},[B]),q(()=>{b&&i!==void 0&&_(i.length>0)},[b,i]);const Se=Oe("TextArea",void 0,{filled:He,disabled:f,variant:r,label:!!c,focused:Ae,error:ve,resizeY:l==="y",autoGrow:Ne}),Ee=e=>{if(f||l!=="y"||!p.current)return;e.preventDefault(),e.stopPropagation();const a=p.current,m=e.currentTarget,D=e.clientY,M=a.getBoundingClientRect().height,{minPx:ke,maxPx:Ie}=U(a);m.setPointerCapture(e.pointerId);const X=z=>{const Ue=M+(z.clientY-D);G(I(Ue,ke,Ie))},x=z=>{window.removeEventListener("pointermove",X),window.removeEventListener("pointerup",x),window.removeEventListener("pointercancel",x);try{m.releasePointerCapture(z.pointerId)}catch{}};window.addEventListener("pointermove",X),window.addEventListener("pointerup",x),window.addEventListener("pointercancel",x)},_e=e=>{e.stopPropagation();const a=e.currentTarget.value;b||Ce(a),_(a.length>0),L==null||L({event:e,value:a})},Fe=e=>{e.stopPropagation(),Y(!1),_(e.currentTarget.value.length>0),N==null||N({event:e,value:e.currentTarget.value})},Re=e=>{e.stopPropagation(),Y(!0),S==null||S({event:e,value:e.currentTarget.value})},De=e=>{e.stopPropagation(),E==null||E({event:e,value:e.currentTarget.value}),(e.key==="Escape"||e.key==="Esc")&&e.currentTarget.blur()},Me=e=>{e.stopPropagation()},ze={maxWidth:r==="default"?void 0:typeof y=="number"?`${y}px`:y,flexShrink:y?0:void 0,minHeight:d!==void 0?typeof d=="number"?`${d}px`:d:l==="y"?`${W}px`:void 0,maxHeight:u!==void 0?typeof u=="number"?`${u}px`:u:void 0,height:l==="y"?`${Le}px`:void 0};return t($e,{children:[t("div",{id:n,className:[Se,s].join(" ").trim(),"data-pui-interactive":"true",ref:F,...Ve,children:[c&&t(be,{className:"TextArea__label",intentModifier:"secondary",size:r==="list"?"medium":"small",truncate:!0,children:c}),t("div",{className:"TextArea__container",style:ze,ref:p,children:[t("textarea",{className:"TextArea__textarea-native",rows:1,ref:e=>{R.current=e},minLength:we,maxLength:Te,disabled:f,placeholder:h,value:K,onChange:_e,onClick:Me,onBlur:Fe,onFocus:Re,onKeyDown:De}),l==="y"&&!f&&t("div",{className:"TextArea__resizeHandle","data-pui-interactive":"true",onPointerDown:Ee})]})]}),$&&t(Ye,{anchorRef:F,children:$})]})},o=Be(Ke),Xe={parameters:{controls:{disable:!0},viewport:{defaultViewport:"large"},docs:{source:{language:"tsx",code:`
...
`}}},render:n=>t("div",{className:"sb-column sb-width-300",children:t(Ge,{children:t(o,{...n})})})},T=Xe,V=je,P=qe,C=Je,A=Qe,H=Ze;var J,Q,Z;w.parameters={...w.parameters,docs:{...(J=w.parameters)==null?void 0:J.docs,source:{originalSource:`{
  tags: ['!autodocs'],
  args: {
    id: undefined,
    className: '',
