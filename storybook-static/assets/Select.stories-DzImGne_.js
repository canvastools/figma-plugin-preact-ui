import{n as e}from"./rolldown-runtime-DAXXjFlN.js";import{C as t,P as n,S as r,j as i,v as a,w as o}from"./compat.module-BiyPQZFw.js";import{n as s,t as c}from"./jsxRuntime.module-XYsEgyrh.js";import{t as l}from"./Text-Dx8we2OT.js";import{Bt as u,Gn as d,Ln as f,Un as p,Vt as m,Xt as h,Zn as g,fn as _,mn as v,t as y}from"./src-fsSRAyCS.js";var b,x=e((()=>{m(),c(),b={parameters:{controls:{disable:!0},viewport:{defaultViewport:`large`},docs:{source:{code:`
const options = [
  { 
    value: "option-1",
    label: "Option one"
...
<Select
  ...
  options={options}
/>
`}}},render:()=>s(`div`,{className:`sb-column sb-width-300`,children:s(u,{options:[{value:`option-1`,label:`Option one`},{value:`option-2`,label:`Option two`},{value:`option-3`,label:`Option three`}],defaultValue:`option-1`})})}})),S,C=e((()=>{o(),y(),m(),c(),S={parameters:{controls:{disable:!0},viewport:{defaultViewport:`large`},docs:{source:{code:`
...
/>
`}}},render:()=>{let[e,t]=r(`option-1`);return s(`div`,{className:`sb-column sb-width-300 sb-gap-16`,children:[s(l,{children:[`value: `,e]}),s(u,{options:[{value:`option-1`,label:`Option one`},{value:`option-2`,label:`Option two`},{value:`option-3`,label:`Option three`}],value:e,onValueChange:e=>t(e.value)})]})}}})),w,T=e((()=>{m(),c(),w={parameters:{controls:{disable:!0},viewport:{defaultViewport:`large`},docs:{source:{language:`tsx`,code:`
<Select placeholder="Placeholder"/>
`}}},render:()=>s(`div`,{className:`sb-column sb-width-300`,children:s(u,{options:[{value:`option-1`,label:`Option one`},{value:`option-2`,label:`Option two`},{value:`option-3`,label:`Option three`}],placeholder:`Placeholder`})})}})),E,D=e((()=>{m(),c(),E={parameters:{controls:{disable:!0},viewport:{defaultViewport:`large`},docs:{source:{code:`
<Select disabled />
`}}},render:()=>{let e=[{value:`option-1`,label:`Option one`},{value:`option-2`,label:`Option two`},{value:`option-3`,label:`Option three`}];return s(`div`,{className:`sb-column sb-width-300 sb-gap-16`,children:[s(u,{options:e,placeholder:`Placeholder`,disabled:!0}),s(u,{options:e,defaultValue:`option-1`,disabled:!0})]})}}})),O,k=e((()=>{y(),m(),c(),O={parameters:{controls:{disable:!0},viewport:{defaultViewport:`large`},docs:{source:{code:`
<Select
  prefix={
    <Icon 
      glyph={search}
...
/>
`}}},render:()=>{let e=[{value:`option-1`,label:`Option one`},{value:`option-2`,label:`Option two`},{value:`option-3`,label:`Option three`}];return s(`div`,{className:`sb-column sb-width-300 sb-gap-16`,children:[s(u,{options:e,defaultValue:`option-1`,prefix:s(d,{glyph:_,intentModifier:`secondary`})}),s(u,{options:e,defaultValue:`option-1`,prefix:s(p,{translucent:!0,icon:{glyph:v}})})]})}}})),A,j=e((()=>{m(),c(),A={parameters:{controls:{disable:!0},viewport:{defaultViewport:`large`},docs:{description:{story:"Use an array of arrays for the `items` property to group options."},source:{code:`
const options = [
  [
...
`}}},render:()=>s(`div`,{className:`sb-column sb-width-300`,children:s(u,{options:[{value:`option-1`,label:`Option one`},{value:`option-2`,label:`Option two`},{value:`option-3`,label:`Option three`},{value:`custom-value`,label:`Custom option`,children:s(({label:e,value:n,disabled:r,focused:o,selected:c,onChange:u})=>{let{registerItem:p,clearFocus:m,setHoveredItem:g}=h(),_=n??`custom-id`,v=a(null);return t(()=>p({id:_,ref:v,disabled:r}),[r,_,p]),s(i,{children:[s(`style`,{children:`
            ...
            `}),s(`div`,{id:_,className:`CustomMenuItem`,ref:v,onClick:e=>{if(r){e.preventDefault();return}e.stopPropagation(),u?.({event:e,value:_})},onMouseEnter:()=>{r||(m(),g(_))},onMouseLeave:()=>{r||g(null)},children:s(`div`,{className:`CustomMenuItem__content`,children:[s(`div`,{style:{width:16,height:16},children:c&&s(d,{glyph:f,size:16,intent:o?`brand`:`neutral-inverted-fixed`,disabled:r})}),s(l,{intent:`neutral-inverted-fixed`,children:[e,o?` [focused]`:null]})]})})]})},{})}],defaultValue:`option-1`,onValueChange:e=>console.log(`onValueChange`,e)})})}})),P,F,I,L,R,z,B,V,H,U,W;e((()=>{x(),C(),T(),D(),k(),j(),N(),y(),m(),c(),{fn:P}=__STORYBOOK_MODULE_TEST__,F={title:`Components/Select`,component:u,tags:[`autodocs`],argTypes:{id:{control:{type:`text`},table:{type:{summary:`string`}}},className:{control:{type:`text`}},options:{control:{disable:!0},description:`Array of options to render in the select.`,table:{type:{summary:`SelectOptionData[] | SelectOptionData[][]`,detail:`
{
