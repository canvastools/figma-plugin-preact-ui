import{d as o,u as t}from"./hooks.module-Dxk9uxGs.js";import{f as L}from"./index-BWINGljf.js";import{L as g,a as m,b as u}from"./ListItem-CrcTxm4P.js";import{T as r}from"./Text-Dvytwbdg.js";import{S as h}from"./Stack-CayROFGf.js";import{S as v}from"./Section-45ajfN6P.js";import"./preact.module-DKQ80Dzn.js";import"./typedForwardRef-cP-mn0Xe.js";import"./compat.module-c0s5p6eE.js";import"./Icon-C8lq2hDK.js";const q={title:"Experimental/ListContext ⚠️",component:g,tags:["autodocs"],parameters:{docs:{description:{component:"<div class='experimental'>Experimental! API may change in future versions.</div> A wrapper component that manages a list state."}}},argTypes:{items:{table:{type:{summary:"ListItemData[]"}},control:{disable:!0},description:`Array of items to manage.
  ...
  children?: ListItemData[]
      ...
      `},selectedItems:{table:{type:{summary:"string[]"}},control:{disable:!0},description:"Array of selected items IDs."},selectionMode:{control:{type:"select"},options:["none","single","multi"],defaultValue:{summary:"single"}},onItemsChange:{action:"itemsChange",description:"Callback function that is called when the item order or structure is changed. Returns an array of items.",table:{type:{summary:"(args: { items: ListItemData[] }) => void"}}},onSelectionChange:{action:"selectionChange",description:"Callback function that is called when the selection is changed. Returns an array of selected items IDs.",table:{type:{summary:"(args: { selectedItems: string[] }) => void"}}},children:{table:{type:{summary:"string | number | JSX.Element"}},control:{disable:!0},description:"Usually &lt;ListContainer/&gt;"},useListContext:{table:{type:{summary:"Hook"}},description:`Use this hook inside a child component to access the context. <br/>
        ...
        `}}},C=[{id:"Frame 1",children:[{id:"Frame 11",children:[{id:"Frame 111"},{id:"Frame 112"}]},{id:"Frame 12",children:[{id:"Frame 121"}]}]},{id:"Frame 2"},{id:"Frame 3",children:[{id:"Frame 31",children:[{id:"Frame 311"},{id:"Frame 312"},{id:"Frame 313"}]}]}],p={tags:["!autodocs"],args:{selectionMode:"single",onItemsChange:L(),onSelectionChange:L()},parameters:{viewport:{defaultViewport:"large"}},render:s=>{const[c,d]=o(C),[a,l]=o([]);return t("div",{className:"sb-column sb-gap-16",children:t(v,{children:t(g,{items:c,selectedItems:a,selectionMode:s.selectionMode,onItemsChange:e=>{var n;d(e.items),(n=s.onItemsChange)==null||n.call(s,e)},onSelectionChange:e=>{var n;l(e.selectedItems),(n=s.onSelectionChange)==null||n.call(s,e)},children:t(m,{children:c.map(e=>t(u,{id:e.id,draggable:!0,selectable:!0,children:t(r,{children:e.id})}))})})})})}},I={parameters:{controls:{disable:!0},docs:{description:{story:"No ability to select items."}},viewport:{defaultViewport:"large"}},render:()=>{const[s,c]=o(C),[d,a]=o([]),l=(e,n)=>!e||e.length===0?null:t(m,{children:e.map(i=>t(u,{id:i.id,draggable:!0,selectable:!0,acceptsChildren:!0,nestingLevel:n,hoverable:!0,subItems:i.children?l(i.children,n+1):void 0,children:t(h,{direction:"row",spacing:200,children:[t(r,{children:i.id}),t(r,{intentModifiers:"secondary",children:["(Level ",n,")"]})]})},i.id))});return t("div",{className:"sb-column sb-gap-16",children:t(v,{children:t(g,{items:s,selectedItems:d,selectionMode:"none",onItemsChange:e=>{c(e.items)},onSelectionChange:e=>{a(e.selectedItems)},children:t(m,{children:s.map(e=>t(u,{id:e.id,draggable:!0,selectable:!0,acceptsChildren:!0,hoverable:!0,subItems:e.children?l(e.children,1):void 0,children:t(h,{direction:"row",spacing:200,children:[t(r,{children:e.id}),t(r,{intentModifiers:"secondary",children:"(Level 0)"})]})},e.id))})})})})}},b={parameters:{controls:{disable:!0},docs:{description:{story:"Single selection mode."}},viewport:{defaultViewport:"large"}},render:()=>{const[s,c]=o(C),[d,a]=o([]),l=(e,n)=>!e||e.length===0?null:t(m,{children:e.map(i=>t(u,{id:i.id,draggable:!0,selectable:!0,acceptsChildren:!0,nestingLevel:n,hoverable:!0,subItems:i.children?l(i.children,n+1):void 0,children:t(h,{direction:"row",spacing:200,children:[t(r,{children:i.id}),t(r,{intentModifiers:"secondary",children:["(Level ",n,")"]})]})},i.id))});return t("div",{className:"sb-column sb-gap-16",children:t(v,{children:t(g,{items:s,selectedItems:d,selectionMode:"single",onItemsChange:e=>{c(e.items)},onSelectionChange:e=>{a(e.selectedItems)},children:t(m,{children:s.map(e=>t(u,{id:e.id,draggable:!0,selectable:!0,acceptsChildren:!0,hoverable:!0,subItems:e.children?l(e.children,1):void 0,children:t(h,{direction:"row",spacing:200,children:[t(r,{children:e.id}),t(r,{intentModifiers:"secondary",children:"(Level 0)"})]})},e.id))})})})})}},S={parameters:{controls:{disable:!0},docs:{description:{story:"Multi selection mode using Shift key or Ctrl/CMD key."}},viewport:{defaultViewport:"large"}},render:()=>{const[s,c]=o(C),[d,a]=o([]),l=(e,n)=>!e||e.length===0?null:t(m,{children:e.map(i=>t(u,{id:i.id,draggable:!0,selectable:!0,acceptsChildren:!0,nestingLevel:n,hoverable:!0,subItems:i.children?l(i.children,n+1):void 0,children:t(h,{direction:"row",spacing:200,children:[t(r,{children:i.id}),t(r,{intentModifiers:"secondary",children:["(Level ",n,")"]})]})},i.id))});return t("div",{className:"sb-column sb-width-full",children:t(v,{children:t(g,{items:s,selectedItems:d,selectionMode:"multi",onItemsChange:e=>{c(e.items)},onSelectionChange:e=>{a(e.selectedItems)},children:t(m,{children:s.map(e=>t(u,{id:e.id,draggable:!0,selectable:!0,acceptsChildren:!0,nestingLevel:0,hoverable:!0,subItems:e.children?l(e.children,1):void 0,children:t(h,{direction:"row",spacing:200,children:[t(r,{children:e.id}),t(r,{intentModifiers:"secondary",children:"(Level 0)"})]})},e.id))})})})})}};var f,y,x;p.parameters={...p.parameters,docs:{...(f=p.parameters)==null?void 0:f.docs,source:{originalSource:`{
  tags: ["!autodocs"],
  args: {
...
}`,...(x=(y=p.parameters)==null?void 0:y.docs)==null?void 0:x.source}}};var M,w,k;I.parameters={...I.parameters,docs:{...(M=I.parameters)==null?void 0:M.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: true
    },
...
}`,...(k=(w=I.parameters)==null?void 0:w.docs)==null?void 0:k.source}}};var T,D,F;b.parameters={...b.parameters,docs:{...(T=b.parameters)==null?void 0:T.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: true
    },
...
}`,...(F=(D=b.parameters)==null?void 0:D.docs)==null?void 0:F.source}}};var N,V,E;S.parameters={...S.parameters,docs:{...(N=S.parameters)==null?void 0:N.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: true
    },
...
}`,...(E=(V=S.parameters)==null?void 0:V.docs)==null?void 0:E.source}}};const z=["Demo","NoSelection","SingleSelection","MultiSelection"];export{p as Demo,S as MultiSelection,I as NoSelection,b as SingleSelection,z as __namedExportsOrder,q as default};
