import{n as e}from"./rolldown-runtime-DAXXjFlN.js";import{n as t,t as n}from"./jsxRuntime.module-B_u_rUE0.js";import{t as r}from"./Text-Bf8YN4P6.js";import{B as i,Ht as a,Kt as o,V as s,Vn as c,Wt as l,fn as u,t as d}from"./src-CnP2aPTs.js";var f,p=e((()=>{d(),s(),n(),f={parameters:{controls:{disable:!0},viewport:{defaultViewport:`large`},docs:{source:{code:`
...
`}}},render:()=>t(`div`,{className:`sb-column sb-width-full`,children:t(o,{width:208,children:[t(i,{children:`Action 1`}),t(i,{intentModifier:`danger`,children:`Action 2`})]})})}})),m,h=e((()=>{d(),s(),n(),m={parameters:{controls:{disable:!0},viewport:{defaultViewport:`large`},docs:{source:{code:`
<MenuItemAction disabled>{children}</MenuItemAction>
`}}},render:()=>t(`div`,{className:`sb-column sb-width-full sb-gap-16`,children:t(o,{width:208,children:[t(i,{children:`Action 1`}),t(i,{disabled:!0,children:`Action 2`}),t(i,{children:`Action 3`})]})})}})),g,_=e((()=>{d(),s(),n(),g={parameters:{controls:{disable:!0},viewport:{defaultViewport:`large`},docs:{source:{code:`
<MenuItemAction 
  prefix={
    <Icon 
      glyph={link}
...
`}}},render:()=>t(`div`,{className:`sb-column sb-width-full`,children:t(o,{width:208,children:[t(i,{prefix:t(c,{glyph:u,size:16,intent:`neutral-inverted-fixed`}),children:`Action 1`}),t(i,{prefix:t(c,{glyph:u,size:16,intent:`neutral-inverted-fixed`}),children:`Action 2`}),t(i,{prefix:t(c,{glyph:u,size:16,intent:`neutral-inverted-fixed`}),children:`Action 3`})]})})}})),v,y=e((()=>{d(),s(),n(),v={parameters:{controls:{disable:!0},viewport:{defaultViewport:`large`},docs:{source:{code:`
<MenuItemAction 
  suffix={
    <Icon 
      glyph={link}
...
`}}},render:e=>t(`div`,{className:`sb-column sb-width-full`,children:t(o,{width:208,children:t(i,{...e,children:e.children})})})},T=f,E=m,D=g,O=v,k=b,w.parameters={...w.parameters,docs:{...w.parameters?.docs,source:{originalSource:`{
  args: {
    id: 'menu-item-action',
    className: '',
