import{n as e}from"./rolldown-runtime-DAXXjFlN.js";import{S as t,w as n}from"./compat.module-BiyPQZFw.js";import{n as r,t as i}from"./jsxRuntime.module-XYsEgyrh.js";import{t as a}from"./Text-Dx8we2OT.js";import{H as o,K as s,W as c,g as l,m as u,q as d,t as f}from"./src-fsSRAyCS.js";var p,m,h,g,_;e((()=>{n(),f(),d(),i(),{fn:p}=__STORYBOOK_MODULE_TEST__,m={title:`Components/ListContext`,component:s,tags:[`autodocs`],parameters:{docs:{description:{component:`A context provider that manages a list state.`}}},argTypes:{items:{control:{disable:!0},table:{type:{summary:`ListItemData[]`,detail:`
{
  id: string // required
  selected: boolean
  items: ListItemData[]
