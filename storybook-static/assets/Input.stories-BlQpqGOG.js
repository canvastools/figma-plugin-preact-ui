import{n as e}from"./rolldown-runtime-DAXXjFlN.js";import{S as t,w as n}from"./compat.module-BiyPQZFw.js";import{n as r,t as i}from"./jsxRuntime.module-XYsEgyrh.js";import{t as a}from"./Text-Dx8we2OT.js";import{Gn as o,Qt as s,Un as c,Zn as l,Zt as u,fn as d,mn as f,t as p}from"./src-fsSRAyCS.js";var m,h=e((()=>{s(),i(),m={parameters:{controls:{disable:!0},viewport:{defaultViewport:`large`},docs:{source:{code:`
<Input defaultValue="Hello World!" />
`}}},render:()=>r(`div`,{className:`sb-column sb-width-300 sb-gap-16`,children:r(u,{defaultValue:`Hello World!`})})}})),g,_=e((()=>{n(),p(),s(),i(),g={parameters:{controls:{disable:!0},viewport:{defaultViewport:`large`},docs:{source:{code:`
...
/>
`}}},render:()=>{let[e,n]=t(`Hello World!`);return r(`div`,{className:`sb-column sb-width-300 sb-gap-16`,children:[r(a,{children:[`value: `,e]}),r(u,{value:e,onValueChange:e=>n(e.value)})]})}}})),v,y=e((()=>{s(),i(),v={parameters:{controls:{disable:!0},viewport:{defaultViewport:`large`},docs:{description:{story:`If there is no label, the component will be displayed in the default variant.`},source:{code:`
<Input variant="default" />

<Input variant="list" />
`}}},render:()=>r(`div`,{className:`sb-column sb-width-300 sb-gap-40`,children:[r(u,{defaultValue:`Hello World!`,label:`Label`,variant:`default`}),r(u,{defaultValue:`Hello World!`,label:`Label`,variant:`list`})]})}})),b,x=e((()=>{s(),i(),b={parameters:{controls:{disable:!0},viewport:{defaultViewport:`large`},docs:{source:{code:`
<Input placeholder="Placeholder" />
`}}},render:()=>r(`div`,{className:`sb-column sb-width-300 sb-gap-16`,children:r(u,{placeholder:`Placeholder`})})}})),S,C=e((()=>{s(),i(),S={parameters:{controls:{disable:!0},viewport:{defaultViewport:`large`},docs:{source:{code:`
<Input disabled />
`}}},render:()=>r(`div`,{className:`sb-column sb-width-300 sb-gap-16`,children:[r(u,{disabled:!0}),r(u,{disabled:!0,placeholder:`Placeholder`}),r(u,{disabled:!0,defaultValue:`Default Value`})]})}})),w,T=e((()=>{p(),s(),i(),w={parameters:{controls:{disable:!0},viewport:{defaultViewport:`large`},docs:{source:{code:`
<Input
  prefix={
    <Icon
      glyph={search}
...
/>
`}}},render:()=>r(`div`,{className:`sb-column sb-width-300 sb-gap-16`,children:[r(u,{placeholder:`Input with prefix`,prefix:r(o,{glyph:d,intentModifier:`secondary`})}),r(u,{placeholder:`Input with prefix (focusOnPrefix)`,focusOnPrefix:!0,prefix:r(o,{glyph:d,intentModifier:`secondary`})})]})}})),E,D=e((()=>{p(),s(),i(),E={parameters:{controls:{disable:!0},viewport:{defaultViewport:`large`},docs:{source:{code:`
<Input
  suffix={
    <ButtonIcon 
      icon={{ glyph: link }} 
...
`}}},render:e=>r(`div`,{className:`sb-column sb-width-300`,children:r(l,{children:r(u,{...e})})})},j=m,M=g,N=v,P=b,F=S,I=w,L=E,A.parameters={...A.parameters,docs:{...A.parameters?.docs,source:{originalSource:`{
  args: {
    id: undefined,
    className: '',
    variant: 'default',
