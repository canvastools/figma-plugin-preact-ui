import{n as e}from"./rolldown-runtime-DAXXjFlN.js";import{C as t,P as n,S as r,j as i,v as a,w as o,x as s,y as c}from"./compat.module-BiyPQZFw.js";import{n as l,t as u}from"./jsxRuntime.module-XYsEgyrh.js";import{D as d,s as f,t as p}from"./utils-DKF8LkKs.js";import{n as m,t as h}from"./Text-Dx8we2OT.js";import{Xn as g,Yn as _,Zn as v,t as y}from"./src-fsSRAyCS.js";var b=e((()=>{}));function x(e,t,n){return Math.min(n,Math.max(t,Math.round(e)))}function S(e){let t=getComputedStyle(e),n=parseFloat(t.minHeight),r=Number.isFinite(n)&&n>0?n:C,i=parseFloat(t.maxHeight);return{minPx:r,maxPx:Number.isFinite(i)?Math.max(r,i):2**53-1}}var C,w,T,E=e((()=>{n(),o(),p(),g(),m(),b(),u(),C=24,w=({id:e,className:n,variant:o=`default`,label:u,placeholder:f,value:p,defaultValue:m,error:g=!1,disabled:v=!1,minLength:y=0,maxLength:b,tooltip:w,autoFocus:T=!1,selectOnFocus:E=!1,maxWidth:D,minHeight:O,maxHeight:k,resize:A,onValueChange:j,onBlur:M,onFocus:N,onKeyDown:P,tabIndex:F,...I},L)=>{let R=p!==void 0,[z,B]=r(()=>m??``),[V,H]=r(!1),[U,W]=r(!!(p??z??``)),[G,K]=r(C),q=a(null),J=a(null),Y=a(null),X=a(null);t(()=>()=>{let e=X.current;e&&(window.removeEventListener(`pointermove`,e.move),window.removeEventListener(`pointerup`,e.up),window.removeEventListener(`pointercancel`,e.up),X.current=null)},[]),c(L,()=>q.current,[]);let Z=R?p??``:z,Q=A!==`y`;s(()=>{if(A!==`y`||!J.current)return;let{minPx:e,maxPx:t}=S(J.current);K(n=>x(n,e,t))},[A,O,k]),s(()=>{let e=Y.current,t=J.current;if(!e||!t)return;if(A===`y`){e.style.removeProperty(`height`);return}e.style.height=`0px`;let{minPx:n,maxPx:r}=S(t),i=x(e.scrollHeight,n,r);e.style.height=`${i}px`},[A,k,O,Z]),t(()=>{if(!T)return;let e=window.setTimeout(()=>{Y.current?.focus()},25);return()=>clearTimeout(e)},[T]),t(()=>{R&&p!==void 0&&W(p.length>0)},[R,p]);let $=d(`TextArea`,void 0,{filled:U,disabled:v,variant:o,label:!!u,focused:V,error:g,resizeY:A===`y`,autoGrow:Q}),ee=e=>{if(v||A!==`y`||!J.current)return;e.preventDefault(),e.stopPropagation();let t=J.current,n=e.currentTarget,r=e.clientY,i=t.getBoundingClientRect().height,{minPx:a,maxPx:o}=S(t);n.setPointerCapture(e.pointerId);let s=e=>{let t=i+(e.clientY-r);K(x(t,a,o))},c=e=>{window.removeEventListener(`pointermove`,s),window.removeEventListener(`pointerup`,c),window.removeEventListener(`pointercancel`,c),X.current=null;try{n.releasePointerCapture(e.pointerId)}catch{}};X.current={move:s,up:c},window.addEventListener(`pointermove`,s),window.addEventListener(`pointerup`,c),window.addEventListener(`pointercancel`,c)},te=e=>{e.stopPropagation();let t=e.currentTarget.value;R||B(t),W(t.length>0),j?.({event:e,value:t})},ne=e=>{e.stopPropagation(),H(!1),W(e.currentTarget.value.length>0),M?.({event:e,value:e.currentTarget.value})},re=e=>{if(e.stopPropagation(),H(!0),E){let t=e.currentTarget;setTimeout(()=>t.select(),0)}N?.({event:e,value:e.currentTarget.value})},ie=e=>{e.stopPropagation(),P?.({event:e,value:e.currentTarget.value}),(e.key===`Escape`||e.key===`Esc`)&&e.currentTarget.blur()},ae=e=>{e.stopPropagation()},oe={maxWidth:o==="default"?void 0:typeof D==`number`?`${D}px`:D,flexShrink:D?0:void 0,minHeight:O===void 0?A===`y`?`${C}px`:void 0:typeof O==`number`?`${O}px`:O,maxHeight:k===void 0?void 0:typeof k==`number`?`${k}px`:k,height:A===`y`?`${G}px`:void 0};return l(i,{children:[l(`div`,{id:e,className:[$,n].join(` `).trim(),"data-pui-interactive":`true`,ref:q,...I,children:[u&&l(h,{className:`TextArea__label`,intentModifier:`secondary`,size:o===`list`?`medium`:`small`,truncate:!0,children:u}),l(`div`,{className:`TextArea__container`,style:oe,ref:J,children:[l(`textarea`,{className:`TextArea__textarea-native`,rows:1,ref:e=>{Y.current=e},minLength:y,maxLength:b,disabled:v,...F===void 0?{}:{tabIndex:F},placeholder:f,value:Z,onInput:te,onClick:ae,onBlur:ne,onFocus:re,onKeyDown:ie}),A===`y`&&!v&&l(`div`,{className:`TextArea__resizeHandle`,"data-pui-interactive":`true`,onPointerDown:ee})]})]}),w&&l(_,{anchorRef:q,children:w})]})},T=f(w)})),D,O=e((()=>{E(),u(),D={parameters:{controls:{disable:!0},viewport:{defaultViewport:`large`},docs:{source:{code:`
<TextArea defaultValue="Hello World!" />
`}}},render:()=>l(`div`,{className:`sb-column sb-width-300 sb-gap-16`,children:l(T,{defaultValue:`Hello World!`})})}})),k,A=e((()=>{o(),y(),E(),u(),k={parameters:{controls:{disable:!0},viewport:{defaultViewport:`large`},docs:{source:{code:`
...
/>
`}}},render:()=>{let[e,t]=r(`Hello World!`);return l(`div`,{className:`sb-column sb-width-300 sb-gap-16`,children:[l(h,{children:[`value: `,e]}),l(T,{value:e,onValueChange:e=>t(e.value)})]})}}})),j,M=e((()=>{E(),u(),j={parameters:{controls:{disable:!0},viewport:{defaultViewport:`large`},docs:{description:{story:`Layout variants with optional label.`},source:{code:`
...
Line two`,label:`Label`,variant:`list`})]})}})),N,P=e((()=>{E(),u(),N={parameters:{controls:{disable:!0},viewport:{defaultViewport:`large`},docs:{source:{code:`
<TextArea placeholder="Placeholder" />
`}}},render:()=>l(`div`,{className:`sb-column sb-width-300 sb-gap-16`,children:l(T,{placeholder:`Placeholder`})})}})),F,I=e((()=>{E(),u(),F={parameters:{controls:{disable:!0},viewport:{defaultViewport:`large`},docs:{source:{code:`
<TextArea disabled />

<TextArea disabled placeholder="Placeholder" />
`}}},render:()=>l(`div`,{className:`sb-column sb-width-300 sb-gap-16`,children:[l(T,{disabled:!0}),l(T,{disabled:!0,placeholder:`Placeholder`}),l(T,{disabled:!0,defaultValue:`Default Value`})]})}})),L,R=e((()=>{E(),u(),L={parameters:{controls:{disable:!0},viewport:{defaultViewport:`large`},docs:{description:{story:`Hover the field to show the corner handle. Drag vertically to resize.`},source:{code:`
<TextArea
  resize="y"
  minHeight={72}
  maxHeight={136}
...
`}}},render:e=>l(`div`,{className:`sb-column sb-width-300`,children:l(v,{children:l(T,{...e})})})},H=D,U=k,W=j,G=N,K=F,q=L,V.parameters={...V.parameters,docs:{...V.parameters?.docs,source:{originalSource:`{
  args: {
    id: undefined,
    className: '',
    variant: 'default',
