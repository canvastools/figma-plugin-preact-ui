...
<WindowResizer 
  ...
  {...args} 
/>
`}}},render:e=>t(`div`,{className:`sb-plugin-window sb-plugin-window-height-480 sb-plugin-window-width-380 sb-plugin-window-center`,children:t(i,{...e})})},s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`{
  args: {
    id: undefined,
    className: '',
    minWidth: 380,
