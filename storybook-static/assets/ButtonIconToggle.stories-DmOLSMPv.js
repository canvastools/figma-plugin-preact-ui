import{n as e}from"./rolldown-runtime-DAXXjFlN.js";import{S as t,w as n}from"./compat.module-BiyPQZFw.js";import{n as r,t as i}from"./jsxRuntime.module-XYsEgyrh.js";import{t as a}from"./Text-Dx8we2OT.js";import{Hn as o,Vn as s,mn as c,t as l}from"./src-fsSRAyCS.js";var u,d=e((()=>{l(),o(),i(),u={parameters:{controls:{disable:!0},viewport:{defaultViewport:`large`},docs:{source:{code:`
<ButtonIconToggle defaultSelected={false}>{children}</ButtonIconToggle>
`}}},render:()=>r(`div`,{className:`sb-column sb-width-420 sb-gap-16`,children:r(s,{defaultSelected:!1,icon:{glyph:c}})})}})),f,p=e((()=>{n(),l(),o(),i(),f={parameters:{controls:{disable:!0},viewport:{defaultViewport:`large`},docs:{source:{code:`
...
`}}},render:e=>r(`div`,{className:`sb-column sb-width-full`,children:r(s,{icon:{glyph:c},...e})})},_=u,v=f,g.parameters={...g.parameters,docs:{...g.parameters?.docs,source:{originalSource:`{
  args: {
