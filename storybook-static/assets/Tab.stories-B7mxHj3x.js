  ...
  render: () => {
    ...
    return <div className="sb-column sb-width-full">
        ...
        setActiveTab(args.value);
          ...
          <Section>
            <TabList>
              <Tab variant="default" value="tab-1" prefix={<Icon glyph={settingsGlyph} variant="scaled" intent="neutral" intentModifiers="default" interactive />}>
                First Tab
              </Tab>
              <Tab variant="default" value="tab-2" prefix={<Icon glyph={searchGlyph} variant="scaled" intent="neutral" intentModifiers="default" interactive />}>
                Second Tab
              </Tab>
            </TabList>
          </Section>
        ...
        <TabContext defaultValue="tab-1">
          <Section>
            <TabList>
              <Tab variant="single" value="tab-1" prefix={<Icon glyph={settingsGlyph} variant="scaled" intent="neutral" intentModifiers="default" />}>
                Single
              </Tab>
            </TabList>
          </Section>
...
}`,...(M=(P=c.parameters)==null?void 0:P.docs)==null?void 0:M.source}}};const q=["Demo","Variant","Prefix","Suffix"];export{l as Demo,d as Prefix,c as Suffix,s as Variant,q as __namedExportsOrder,j as default};
