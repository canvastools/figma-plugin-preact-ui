import{n as e}from"./rolldown-runtime-DAXXjFlN.js";import{S as t,w as n}from"./compat.module-BiyPQZFw.js";import{n as r,t as i}from"./jsxRuntime.module-XYsEgyrh.js";import{t as a}from"./Text-Dx8we2OT.js";import{Gn as o,Gt as s,Jt as c,Kt as l,Wt as u,m as d,mn as f,t as p}from"./src-fsSRAyCS.js";var m,h=e((()=>{p(),s(),i(),m={parameters:{controls:{disable:!0},viewport:{defaultViewport:`large`},docs:{source:{code:`
<MenuItemOption defaultSelected={true}>
  {children}
</MenuItemOption>
`}}},render:()=>r(`div`,{className:`sb-column sb-width-full`,children:r(l,{width:208,children:[r(u,{defaultSelected:!0,children:`Menu Item Option 1`}),r(u,{children:`Menu Item Option 2`}),r(u,{children:`Menu Item Option 3`})]})})}})),g,_=e((()=>{n(),p(),s(),i(),g={parameters:{controls:{disable:!0},viewport:{defaultViewport:`large`},docs:{source:{code:`
...
`}}},render:()=>{let[e,n]=t(`option-1`);return r(`div`,{className:`sb-column sb-width-full sb-gap-16`,children:r(d,{spacing:400,children:[r(a,{children:[`Selected: `,e]}),r(l,{width:208,children:[r(u,{id:`option-1`,selected:e===`option-1`,onSelectedChange:e=>n(e.id),children:`Menu Item Option 1`}),r(u,{id:`option-2`,selected:e===`option-2`,onSelectedChange:e=>n(e.id),children:`Menu Item Option 2`}),r(u,{id:`option-3`,selected:e===`option-3`,onSelectedChange:e=>n(e.id),children:`Menu Item Option 3`})]})]})})}}})),v,y=e((()=>{p(),s(),i(),v={parameters:{controls:{disable:!0},viewport:{defaultViewport:`large`},docs:{source:{code:`
<MenuItemOption disabled>{children}</MenuItemOption>
`}}},render:()=>r(`div`,{className:`sb-column sb-width-full`,children:r(l,{width:208,children:[r(u,{defaultSelected:!0,children:`Menu Item Option 1`}),r(u,{disabled:!0,children:`Menu Item Option 2`}),r(u,{children:`Menu Item Option 3`})]})})}})),b,x=e((()=>{p(),s(),i(),b={parameters:{controls:{disable:!0},viewport:{defaultViewport:`large`},docs:{source:{code:`
<MenuItemOption 
  prefix={
    <Icon 
      glyph={link}
...
`}}},render:()=>r(`div`,{className:`sb-column sb-width-full`,children:r(l,{width:208,children:[r(u,{defaultSelected:!0,prefix:r(o,{glyph:f,size:16,intent:`neutral-inverted-fixed`}),children:`Menu Item Option 1`}),r(u,{prefix:r(o,{glyph:f,size:16,intent:`neutral-inverted-fixed`}),children:`Menu Item Option 2`}),r(u,{prefix:r(o,{glyph:f,size:16,intent:`neutral-inverted-fixed`}),children:`Menu Item Option 3`})]})})}})),S,C=e((()=>{p(),s(),i(),S={parameters:{controls:{disable:!0},viewport:{defaultViewport:`large`},docs:{source:{code:`
<MenuItemOption 
  suffix={
    <Icon 
      glyph={link}
...
`}}},render:e=>r(`div`,{className:`sb-column sb-width-full`,children:r(c,{children:r(l,{width:208,children:r(u,{...e,children:e.children})})})})},D=m,O=g,k=v,A=b,j=S,E.parameters={...E.parameters,docs:{...E.parameters?.docs,source:{originalSource:`{
  args: {
    id: 'menu-item-option',
    className: '',
