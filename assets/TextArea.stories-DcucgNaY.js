import{d as g,A as k,F as $e,_ as j,y as q,u as t}from"./hooks.module-6Sbq__eq.js";import{f as v}from"./index-B4E_jmCM.js";import{S as Be}from"./preact.module-gH5CyEHP.js";import{t as Ye,b as Ge}from"./typedForwardRef-CtFJgl6m.js";import{T as be}from"./Text-BbQ_b1VF.js";import{T as Ke,a as Xe}from"./TooltipContext-DB8mQxid.js";import"./compat.module-CHmB9zKI.js";import"./TooltipContainer-CJCq4A9v.js";const U=24;function I(n,s,r){return Math.min(r,Math.max(s,Math.round(n)))}function O(n){const s=getComputedStyle(n),r=parseFloat(s.minHeight),c=Number.isFinite(r)&&r>0?r:U,h=parseFloat(s.maxHeight),i=Number.isFinite(h)?Math.max(c,h):Number.MAX_SAFE_INTEGER;return{minPx:c,maxPx:i}}const je=({id:n,className:s,variant:r="default",label:c,placeholder:h,value:i,defaultValue:xe,error:ve=!1,disabled:f=!1,minLength:we=0,maxLength:Te,tooltip:W,autoFocus:$=!1,selectOnFocus:Ve=!1,maxWidth:y,minHeight:d,maxHeight:u,resize:l,onValueChange:H,onBlur:L,onFocus:N,onKeyDown:E,tabIndex:Pe,...Ce},Ae)=>{const b=i!==void 0,[B,Se]=g(()=>xe??""),[He,Y]=g(!1),[Le,F]=g(!!(i??B??"")),[Ne,G]=g(U),_=k(null),m=k(null),R=k(null);$e(Ae,()=>_.current,[]);const K=b?i??"":B,Ee=l!=="y";j(()=>{if(l!=="y"||!m.current)return;const{minPx:e,maxPx:a}=O(m.current);G(p=>I(p,e,a))},[l,d,u]),j(()=>{const e=R.current,a=m.current;if(!e||!a)return;if(l==="y"){e.style.removeProperty("height");return}e.style.height="0px";const{minPx:p,maxPx:D}=O(a),M=I(e.scrollHeight,p,D);e.style.height=`${M}px`},[l,u,d,K]),q(()=>{if(!$)return;const e=window.setTimeout(()=>{var a;(a=R.current)==null||a.focus()},25);return()=>clearTimeout(e)},[$]),q(()=>{b&&i!==void 0&&F(i.length>0)},[b,i]);const Fe=Ge("TextArea",void 0,{filled:Le,disabled:f,variant:r,label:!!c,focused:He,error:ve,resizeY:l==="y",autoGrow:Ee}),_e=e=>{if(f||l!=="y"||!m.current)return;e.preventDefault(),e.stopPropagation();const a=m.current,p=e.currentTarget,D=e.clientY,M=a.getBoundingClientRect().height,{minPx:Oe,maxPx:Ue}=O(a);p.setPointerCapture(e.pointerId);const X=z=>{const We=M+(z.clientY-D);G(I(We,Oe,Ue))},x=z=>{window.removeEventListener("pointermove",X),window.removeEventListener("pointerup",x),window.removeEventListener("pointercancel",x);try{p.releasePointerCapture(z.pointerId)}catch{}};window.addEventListener("pointermove",X),window.addEventListener("pointerup",x),window.addEventListener("pointercancel",x)},Re=e=>{e.stopPropagation();const a=e.currentTarget.value;b||Se(a),F(a.length>0),H==null||H({event:e,value:a})},De=e=>{e.stopPropagation(),Y(!1),F(e.currentTarget.value.length>0),L==null||L({event:e,value:e.currentTarget.value})},Me=e=>{if(e.stopPropagation(),Y(!0),Ve){const a=e.currentTarget;setTimeout(()=>a.select(),0)}N==null||N({event:e,value:e.currentTarget.value})},ze=e=>{e.stopPropagation(),E==null||E({event:e,value:e.currentTarget.value}),(e.key==="Escape"||e.key==="Esc")&&e.currentTarget.blur()},ke=e=>{e.stopPropagation()},Ie={maxWidth:r==="default"?void 0:typeof y=="number"?`${y}px`:y,flexShrink:y?0:void 0,minHeight:d!==void 0?typeof d=="number"?`${d}px`:d:l==="y"?`${U}px`:void 0,maxHeight:u!==void 0?typeof u=="number"?`${u}px`:u:void 0,height:l==="y"?`${Ne}px`:void 0};return t(Be,{children:[t("div",{id:n,className:[Fe,s].join(" ").trim(),"data-pui-interactive":"true",ref:_,...Ce,children:[c&&t(be,{className:"TextArea__label",intentModifier:"secondary",size:r==="list"?"medium":"small",truncate:!0,children:c}),t("div",{className:"TextArea__container",style:Ie,ref:m,children:[t("textarea",{className:"TextArea__textarea-native",rows:1,ref:e=>{R.current=e},minLength:we,maxLength:Te,disabled:f,tabIndex:Pe,placeholder:h,value:K,onChange:Re,onClick:ke,onBlur:De,onFocus:Me,onKeyDown:ze}),l==="y"&&!f&&t("div",{className:"TextArea__resizeHandle","data-pui-interactive":"true",onPointerDown:_e})]})]}),W&&t(Ke,{anchorRef:_,children:W})]})},o=Ye(je),qe={parameters:{controls:{disable:!0},viewport:{defaultViewport:"large"},docs:{source:{language:"tsx",code:`
...
`}}},render:n=>t("div",{className:"sb-column sb-width-300",children:t(Xe,{children:t(o,{...n})})})},T=qe,V=Je,P=Qe,C=Ze,A=et,S=tt;var J,Q,Z;w.parameters={...w.parameters,docs:{...(J=w.parameters)==null?void 0:J.docs,source:{originalSource:`{
  tags: ['!autodocs'],
  args: {
    id: undefined,
    className: '',
