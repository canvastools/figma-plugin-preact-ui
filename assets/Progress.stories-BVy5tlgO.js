...
<Progress
  ...
  value={value}
/>
`}}},render:()=>{let[e,t]=n(0);return i(`div`,{className:`sb-column sb-width-full sb-gap-16`,children:[i(l,{children:[`Value: `,e]}),i(h,{variant:`determinate`,value:e}),i(u,{direction:`row`,spacing:200,children:[i(d,{intent:`brand`,onClick:()=>{let e=()=>{t(t=>{let n=Math.min(t+5,100);return n<100&&setTimeout(e,100),n})};e()},children:`Fill it!`}),i(d,{onClick:()=>t(0),children:`Reset`})]})]})}}})),y,b=e((()=>{g(),a(),y={parameters:{controls:{disable:!0},viewport:{defaultViewport:`large`},docs:{source:{code:`
