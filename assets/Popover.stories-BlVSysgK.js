import{n as e}from"./rolldown-runtime-DAXXjFlN.js";import{S as t,v as n,w as r}from"./compat.module-BiyPQZFw.js";import{n as i,t as a}from"./jsxRuntime.module-XYsEgyrh.js";import{t as o}from"./Text-Dx8we2OT.js";import{D as s,O as c,S as l,b as u,m as d,qn as f,t as p}from"./src-BW54aR7x.js";var m,h=e((()=>{r(),p(),c(),a(),m={parameters:{controls:{disable:!0},viewport:{defaultViewport:`large`},docs:{source:{code:`
...
`}}},render:()=>{let e=n(null),[r,a]=t(!1);return i(`div`,{className:`sb-column sb-width-full sb-gap-16`,children:[i(o,{children:[`Open: `,r?`true`:`false`]}),i(f,{ref:e,onClick:()=>a(!r),children:`Open Popover`}),i(s,{triggerRef:e,open:r,onClose:()=>a(!1),popoverHeaderProps:{children:`Controlled Popover`},children:i(u,{children:i(o,{children:`Lorem ipsum dolor sit amet consectetur adipisicing elit.`})})})]})}}})),g,_=e((()=>{r(),p(),c(),a(),g={parameters:{controls:{disable:!0},viewport:{defaultViewport:`large`},docs:{source:{code:`
const triggerRef = useRef(null)
...
`}}},render:()=>{let e=n(null);return i(`div`,{className:`sb-column sb-width-full sb-gap-16`,children:[i(f,{ref:e,children:`Open Menu`}),i(s,{triggerRef:e,popoverHeaderProps:{children:`Uncontrolled Popover`},children:i(u,{children:i(o,{children:`Lorem ipsum dolor sit amet consectetur adipisicing elit.`})})})]})}}})),v,y=e((()=>{r(),p(),c(),a(),v={parameters:{controls:{disable:!0},viewport:{defaultViewport:`large`},docs:{source:{code:`
const triggerRef = useRef(null)
...
`}}},render:()=>{let e=n(null);return i(`div`,{className:`sb-column sb-width-full sb-gap-16`,children:[i(f,{ref:e,children:`Open Menu`}),i(s,{triggerRef:e,popoverHeaderProps:{children:`Popover with an arrow`},showArrow:!0,children:i(u,{children:i(o,{children:`Lorem ipsum dolor sit amet consectetur adipisicing elit.`})})})]})}}})),b,x=e((()=>{r(),p(),c(),a(),b={parameters:{controls:{disable:!0},viewport:{defaultViewport:`small`},docs:{source:{code:`
const triggerRef = useRef(null)
const [open, setOpen] = useState(false)
...
`}}},render:e=>{let t=n(null);return i(`div`,{className:`sb-column sb-width-full`,children:[i(f,{ref:t,children:`Open Popover`}),i(s,{triggerRef:t,...e,children:i(u,{children:i(o,{children:e.children})})})]})}},w=g,T=m,E=v,D=b,C.parameters={...C.parameters,docs:{...C.parameters?.docs,source:{originalSource:`{
  args: {
    id: undefined,
    className: '',
    children: 'Content',
