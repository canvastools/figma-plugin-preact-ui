import{u as e,d as Y,A as Z,h as $}from"./hooks.module-BOklADZz.js";import{f}from"./index-B4E_jmCM.js";import{S as t}from"./Select-CYLHhZhR.js";import{T as K}from"./Text-DWXnbeUo.js";import{I as Q}from"./Icon-CUZDBV4V.js";import{s as ee}from"./search-C4EXOgPf.js";import{B as oe}from"./ButtonIcon-D68A8Iw5.js";import{l as te}from"./link-D0beuj1-.js";import{S as ne}from"./preact.module-BEcQExD3.js";import{u as re}from"./MenuContainer-7RiBAaMv.js";import{c as ae}from"./check-CJonqv9k.js";import{a as le}from"./TooltipContext-AO-nQ0Om.js";import"./typedForwardRef-IM0ZXC4v.js";import"./compat.module-C06LZZ-F.js";import"./chevronDown-CZFzKRGi.js";import"./MenuDivider-DCMEePNQ.js";import"./MenuItemOption-DsKPVta5.js";import"./chevronUp-Cq7Nn1oc.js";import"./TooltipContainer-CxrP3vc5.js";const se={parameters:{controls:{disable:!0},viewport:{defaultViewport:"large"},docs:{source:{language:"tsx",code:`
const options = [
  { 
    value: "option-1",
    label: "Option one"
            ...
            `}),e("div",{id:r,className:"CustomMenuItem",ref:w,onClick:l=>{if(n){l.preventDefault();return}l.stopPropagation(),h==null||h({event:l,value:r})},onMouseEnter:()=>{n||(X(),O(r))},onMouseLeave:()=>{n||O(null)},children:e("div",{className:"CustomMenuItem__content",children:[e("div",{style:{width:16,height:16},children:W&&e(Q,{glyph:ae,size:16,intent:y?"brand":"neutral-inverted-fixed",disabled:n})}),e(K,{intent:"neutral-inverted-fixed",children:[a,y?" [focused]":null]})]})})]})},{})}],defaultValue:"option-1",onValueChange:a=>console.log("onValueChange",a)})})},Ue={title:"Components/Select",component:t,tags:["autodocs"],argTypes:{id:{control:{type:"text"},table:{type:{summary:"string"}}},className:{control:{type:"text"}},options:{control:{disable:!0},description:"Array of options to render in the select.",table:{type:{summary:"SelectOptionData[] | SelectOptionData[][]",detail:`
{
  ...
  children: preact.ComponentChildren
            ...
            `}}},placeholder:{control:{type:"text"}},value:{control:{disable:!0},description:"Value for controlled state.",table:{type:{summary:"string"}}},defaultValue:{control:{type:"text"},description:"Value for uncontrolled state.",table:{type:{summary:"string"}}},grouped:{control:{type:"radio"},options:[void 0,"first","last","middle"]},ghost:{control:{type:"boolean"},defaultValue:{summary:!1}},error:{control:{type:"boolean"},defaultValue:{summary:"false"}},disabled:{control:{type:"boolean"},defaultValue:{summary:"false"}},prefix:{control:{disable:!0},description:"Element displayed before value.",table:{type:{summary:"preact.ComponentChildren"}}},tooltip:{control:{control:"text"},table:{type:{summary:"preact.ComponentChildren"}}},tabIndex:{control:{type:"number"},description:"Tab order of the select trigger. Omit for 0 when enabled and -1 when disabled.",table:{type:{summary:"number"}}},onBlur:{table:{type:{summary:"() => void"}}},onFocus:{table:{type:{summary:"() => void"}}},onValueChange:{table:{type:{summary:"(args) => void",detail:`
args: {
  event: MouseEvent
  value: string
}
          `}}},menuContainerProps:{control:{disable:!0},table:{type:{summary:"Pick<MenuContainerProps>",detail:`
{
  width: number
          ...
          `}}}}},s={tags:["!autodocs"],args:{id:void 0,className:"",placeholder:"Placeholder",defaultValue:"",grouped:void 0,ghost:!1,error:!1,disabled:!1,tooltip:"Select tooltip",onBlur:f(),onFocus:f(),onValueChange:f()},parameters:{viewport:{defaultViewport:"large"},docs:{source:{language:"tsx",code:`
<Select {...args} />
...
`}}},render:o=>e("div",{className:"sb-column sb-width-300",children:e(le,{children:e(t,{options:[{value:"option-1",label:"Option one"},{value:"option-2",label:"Option two"},{value:"option-3",label:"Option three"}],...o})})})},i=se,u=ie,p=ue,c=pe,d=ce,m=de,b=me;var x,S,V;s.parameters={...s.parameters,docs:{...(x=s.parameters)==null?void 0:x.docs,source:{originalSource:`{
  tags: ['!autodocs'],
  args: {
    id: undefined,
    className: '',
