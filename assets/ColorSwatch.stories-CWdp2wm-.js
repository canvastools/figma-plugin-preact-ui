...
`}}},render:()=>r(`div`,{className:`sb-row sb-width-full sb-gap-16`,children:[r(o,{fill:{r:255,g:0,b:0,a:1}}),r(o,{fill:{r:255,g:0,b:0,a:.5}}),r(o,{fill:{r:255,g:0,b:0,a:0}})]})}})),_,v=e((()=>{l(),f(),i(),_={parameters:{controls:{disable:!0},viewport:{defaultViewport:`large`},docs:{source:{code:`
...
`}}},render:()=>r(`div`,{className:`sb-column sb-width-full sb-gap-16`,children:r(o,{disabled:!0})})}})),x,S=e((()=>{n(),f(),l(),i(),x={parameters:{controls:{disable:!0},viewport:{defaultViewport:`large`},docs:{source:{code:`
...
/>
`}}},render:()=>r(`div`,{className:`sb-column sb-width-full sb-gap-16`,children:[r(a,{children:`Alpha: true`}),r(u,{direction:`row`,spacing:`200`,children:[r(o,{fill:[N,F],size:`large`,selection:`rainbow`}),r(o,{fill:[P,I],size:`large`,selection:`rainbow`}),r(o,{fill:[A,j],size:`large`,selection:`rainbow`}),r(o,{fill:[M,I],size:`large`,selection:`rainbow`})]}),r(a,{children:`Alpha: false`}),r(u,{direction:`row`,spacing:`200`,children:[r(o,{fill:[N,F],size:`large`,alpha:!1}),r(o,{fill:[P,I],size:`large`,alpha:!1}),r(o,{fill:[A,j],size:`large`,alpha:!1}),r(o,{fill:[M,I],size:`large`,alpha:!1})]})]})}})),z,B,V,H,U,W,G,K,q,J,Y,X;e((()=>{m(),g(),v(),b(),S(),w(),k(),R(),f(),l(),i(),{fn:z}=__STORYBOOK_MODULE_TEST__,B={title:`Components/ColorSwatch`,component:o,tags:[`autodocs`],argTypes:{id:{control:{type:`text`},table:{type:{summary:`string`}}},className:{control:{type:`text`}},size:{control:{type:`radio`},options:[`small`,`medium`,`large`],table:{defaultValue:{summary:`medium`}}},fill:{control:{type:`object`},table:{type:{summary:`Color | GradientPaint | Array<Color | GradientPaint>`,detail:`
Color:{
  r: number
  g: number
  b: number
...
`}}},render:e=>r(`div`,{className:`sb-column sb-width-full`,children:r(d,{children:r(o,{...e})})})},H=p,U=h,W=_,G=y,K=x,q=C,J=O,Y=L,V.parameters={...V.parameters,docs:{...V.parameters?.docs,source:{originalSource:`{
  args: {
    id: undefined,
    className: '',
    size: 'medium',
