import{u as e}from"./hooks.module-Dxk9uxGs.js";import{f as w}from"./index-BWINGljf.js";import{M as n}from"./MenuItem-CUmKU8YF.js";import{M as s}from"./MenuContainer-x2qcv_BJ.js";import{I as t}from"./Icon-Btq4UltS.js";import{T as C}from"./Text-C438qO9S.js";import{B as P}from"./Badge-DPBljnKj.js";import{a as I}from"./ai-DHHkDKoh.js";import{a as N}from"./adjust-DIhYuODF.js";import{l as x}from"./link-Bngbaf4L.js";import"./preact.module-DKQ80Dzn.js";import"./typedForwardRef-Bwgl65_g.js";import"./compat.module-CA66vPNl.js";const _={title:"Components/MenuItem",component:n,tags:["autodocs"],parameters:{docs:{description:{component:"Used within &lt;MenuContainer/&gt;."}}},argTypes:{className:{control:{type:"text"}},disabled:{control:{type:"boolean"},defaultValue:{summary:!1},table:{type:{summary:"boolean"}}},prefix:{control:{disable:!0},description:"Element inserted before children.",table:{type:{summary:"JSX.Element"}}},suffix:{control:{disable:!0},description:"Element inserted after children.",table:{type:{summary:"JSX.Element"}}},children:{control:{disable:!0},table:{type:{summary:"JSX.Element"}}},reducedPaddingRight:{control:{type:"boolean"},defaultValue:{summary:!1},description:"Indicates if the item has reduced padding on the right. For pixel perfect vertical alignment of the chevron for nested menus.",table:{type:{summary:"boolean"}}},onClick:{control:{disable:!0},description:"Callback when the item is clicked.",table:{type:{summary:"({ event: MouseEvent }) => void"}}}}},r={tags:["!autodocs"],args:{className:"",disabled:!1,reducedPaddingRight:!1,onClick:w()},parameters:{viewport:{defaultViewport:"large"}},render:y=>e("div",{className:"sb-column sb-width-full",children:e(s,{width:208,children:e(n,{...y,children:"Menu Item"})})})},i={parameters:{viewport:{defaultViewport:"large"}},render:()=>e("div",{className:"sb-column sb-width-full",children:e(s,{width:208,children:e(n,{disabled:!0,children:"Menu Item"})})})},a={parameters:{viewport:{defaultViewport:"large"}},render:()=>e("div",{className:"sb-column sb-width-full",children:e(s,{width:208,children:[e(n,{prefix:e(t,{glyph:I,size:16,intent:"neutral-inverted-fixed",interactive:!0}),children:"Menu Item"}),e(n,{prefix:e(t,{glyph:N,size:16,intent:"neutral-inverted-fixed",interactive:!0}),children:"Menu Item"}),e(n,{disabled:!0,prefix:e(t,{glyph:x,size:16,intent:"neutral-inverted-fixed",interactive:!0,disabled:!0}),children:"Menu Item"})]})})},d={parameters:{viewport:{defaultViewport:"large"}},render:()=>e("div",{className:"sb-column sb-width-full",children:e(s,{width:208,children:[e(n,{reducedPaddingRight:!0,suffix:e(C,{intent:"neutral-inverted-fixed",intentModifiers:"secondary",children:"Action"}),children:"Menu Item"}),e(n,{reducedPaddingRight:!0,suffix:e(t,{glyph:I,size:16,intent:"neutral-inverted-fixed",interactive:!0}),children:"Menu Item"}),e(n,{reducedPaddingRight:!0,suffix:e(P,{intent:"brand",children:"Badge"}),children:"Menu Item"}),e(n,{disabled:!0,reducedPaddingRight:!0,suffix:e(t,{glyph:x,size:16,intent:"neutral-inverted-fixed",interactive:!0,disabled:!0}),children:"Menu Item"})]})})};var l,o,u;r.parameters={...r.parameters,docs:{...(l=r.parameters)==null?void 0:l.docs,source:{originalSource:`{
...
}`,...(u=(o=r.parameters)==null?void 0:o.docs)==null?void 0:u.source}}};var m,c,p;i.parameters={...i.parameters,docs:{...(m=i.parameters)==null?void 0:m.docs,source:{originalSource:`{
  parameters: {
    viewport: {
      defaultViewport: "large"
    }
  ...
  render: () => <div className="sb-column sb-width-full">
      <MenuContainer width={208}>
        <MenuItem prefix={<Icon glyph={glyphs.ai} size={16} intent="neutral-inverted-fixed" interactive />}>
          Menu Item
        </MenuItem>
        <MenuItem prefix={<Icon glyph={glyphs.adjust} size={16} intent="neutral-inverted-fixed" interactive />}>
          Menu Item
        </MenuItem>
        <MenuItem disabled prefix={<Icon glyph={glyphs.link} size={16} intent="neutral-inverted-fixed" interactive disabled />}>
          Menu Item
        </MenuItem>
      </MenuContainer>
    </div>
  ...
  render: () => <div className="sb-column sb-width-full">
      <MenuContainer width={208}>
        ...
        <MenuItem reducedPaddingRight suffix={<Icon glyph={glyphs.ai} size={16} intent="neutral-inverted-fixed" interactive />}>
          Menu Item
        </MenuItem>
        <MenuItem reducedPaddingRight suffix={<Badge intent="brand">Badge</Badge>}>
          Menu Item
        </MenuItem>
        <MenuItem disabled reducedPaddingRight suffix={<Icon glyph={glyphs.link} size={16} intent="neutral-inverted-fixed" interactive disabled />}>
          Menu Item
        </MenuItem>
      </MenuContainer>
    </div>
}`,...(v=(b=d.parameters)==null?void 0:b.docs)==null?void 0:v.source}}};const F=["Demo","Disabled","Prefix","Suffix"];export{r as Demo,i as Disabled,a as Prefix,d as Suffix,F as __namedExportsOrder,_ as default};
