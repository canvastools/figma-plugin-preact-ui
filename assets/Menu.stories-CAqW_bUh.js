...
<Menu 
  ...
  items={items}
/>
`}}},render:()=>{let e=a(null);return s(`div`,{className:`sb-column sb-width-full sb-gap-40`,children:[s(f,{ref:e,children:`Open Menu`}),s(u,{triggerRef:e,items:[{type:`action`,id:`action-1`,children:`Action 1`,closeOnClick:!0,onClick:()=>console.log(`action-1 clicked`)},{type:`action`,id:`action-2`,children:`Action 2`,closeOnClick:!0,onClick:()=>console.log(`action-2 clicked`)},{type:`action`,id:`action-3`,children:`Action 3`,closeOnClick:!0,onClick:()=>console.log(`action-3 clicked`)},{type:`custom`,id:`custom-item`,children:s(({id:e,children:n,disabled:r,focused:o,onClick:c})=>{let u=e??`custom-id`,{registerItem:d,clearFocus:f,setHoveredItem:m}=p(),h=a(null);return t(()=>d({id:u,ref:h,disabled:r}),[r,d,u]),s(i,{children:[s(`style`,{children:`
            .CustomMenuItem {
            ...
            `}),s(`div`,{id:u,className:`CustomMenuItem`,ref:h,onClick:e=>{if(r){e.preventDefault();return}e.stopPropagation(),c?.({event:e,id:u})},onMouseEnter:()=>{r||(f(),m(u))},onMouseLeave:()=>{r||m(null)},children:s(`div`,{className:`CustomMenuItem__content`,children:s(l,{intent:`neutral-inverted-fixed`,children:[n,` `,o?` [focused]`:null]})})})]})},{children:`Custom item`}),onClick:()=>console.log(`custom-item clicked`)}]})]})}}})),x,S,C,w,T,E,D;e((()=>{o(),g(),v(),b(),d(),m(),c(),{fn:x}=__STORYBOOK_MODULE_TEST__,S={title:`Components/Menu`,component:u,tags:[`autodocs`],parameters:{docs:{description:{component:`A facade component that provides a simplified API for menus.`}}},argTypes:{id:{control:{type:`text`},table:{type:{summary:`string`}}},className:{control:{type:`text`}},items:{control:{disable:!0},description:`<strong>*</strong>Array of items to render in the menu.`,table:{type:{summary:`MenuItemData[]`,detail:`
