...
`}}},render:e=>{let n=t(null);return r(`div`,{className:`sb-column sb-width-300 sb-container`,children:r(c,{children:[r(a,{ref:n,children:`Hover to see Tooltip.`}),r(o,{anchorRef:n,...e})]})})}},f={args:{trigger:`click`,showDelay:0,hideDelay:0,children:`Click tooltip content`},parameters:{viewport:{defaultViewport:`large`},docs:{source:{code:`
const anchorRef = useRef(null)
...
`}}},render:e=>{let n=t(null);return r(`div`,{className:`sb-column sb-width-300 sb-container`,children:r(c,{children:[r(a,{ref:n,children:`Click to see Tooltip.`}),r(o,{anchorRef:n,...e})]})})}},d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`{
  args: {
    id: undefined,
    className: '',
    trigger: 'hover',
