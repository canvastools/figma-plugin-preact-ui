...
>
  {renderItems(items, 0)}
        ...
        `}}},render:e=>{let[n,i]=t(p),[,o]=t([]),d=(t,n)=>r(l,{...e,children:t.map(e=>r(s,{id:e.id,nestingLevel:n,items:e.items&&e.items.length?d(e.items,n+1):void 0,children:r(u,{direction:`row`,y:`center`,children:[r(u,{direction:`row`,y:`center`,children:r(a,{wrap:!1,children:e.id})}),r(a,{intentModifier:`secondary`,wrap:!1,children:[`\xA0(Level `,n,`)`]})]})},e.id))});return r(`div`,{className:`sb-column sb-width-full`,children:r(c,{items:n,selectionMode:`multi`,onItemsChange:e=>{i(e.items)},onSelectionChange:e=>{o(e.selectedItemIds)},children:d(n,0)})})}},m.parameters={...m.parameters,docs:{...m.parameters?.docs,source:{originalSource:`{
  args: {
    id: undefined,
