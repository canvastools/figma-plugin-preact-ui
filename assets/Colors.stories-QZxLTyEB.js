...
}`}}}};function w(r,l=[]){const t={};for(const[c,d]of Object.entries(r)){const f=[...l,c];typeof d=="string"?t[f.join("-")]=d:typeof d=="object"&&d!==null&&Object.assign(t,w(d,f))}return t}function G(r,l){const t={},c=new Set(Object.entries(r.intents).filter(([,F])=>F).map(([F])=>F)),d=new Set(Object.entries(r.elements).filter(([,F])=>F).map(([F])=>F));for(const[F,b]of Object.entries(l)){const m=w(b.variables);for(const[a,s]of Object.entries(m)){const o=a.split("-"),n=o.findIndex(_=>_ in r.elements),p=n>0?o.slice(0,n).join("-"):o[0],i=n>0?o[n]:void 0;c.has(p)&&(i&&i in r.elements&&!d.has(i)||(t[a]||(t[a]={}),t[a][F]=s))}}const f=Object.keys(l);for(const F of Object.keys(t))for(const b of f)b in t[F]||(t[F][b]=void 0);return t}const $={figmaLight:L,figmaDark:I,figjamLight:z},M=r=>{const l=G(r,$),t=Object.keys(l),c=Object.keys(r.intents).filter(a=>r.intents[a]),d=Object.keys(r.elements).filter(a=>r.elements[a]),f=x.filter(a=>r.themes[a.key]).map(a=>a.key),F=a=>{const s=a.split("-"),o=s.findIndex(i=>i in r.elements),n=o>0?s.slice(0,o).join("-"):s[0],p=o>0?s[o]:void 0;return{intent:n,element:p}},b=a=>e("tr",{className:"sb-variables-table__row-border",children:[e("td",{className:"sb-variables-table__cell",children:e("div",{className:"sb-variables-table__flex",children:[e(v,{onClick:()=>D(`--pui-color-${a}`),children:e(y,{glyph:B})}),e("div",{className:"sb-variables-table__name",children:e(u,{strong:!0,wrap:!1,children:["--pui-color-",a]})})]})}),f.map(s=>e("td",{className:"sb-variables-table__cell",children:l[a][s]?e("div",{className:"sb-variables-table__flex--gap",children:[e(v,{onClick:()=>D(l[a][s]),children:e(y,{glyph:B})}),e(N,{disabled:!0,fill:O(l[a][s])}),e("div",{className:"sb-variables-table__name",children:e(u,{strong:!0,wrap:!1,children:l[a][s]})})]}):null},s))]},`token-${a}`),m=[];for(const a of c){const s=t.filter(n=>F(n).intent===a);if(s.length===0)continue;m.push(e("tr",{className:"sb-variables-table__row-intent",children:e("td",{colSpan:1+f.length,className:"sb-variables-table__cell--compact",children:e(u,{strong:!0,children:a})})},`intent-divider-${a}`));const o=new Set(s);for(const n of d){const p=s.filter(i=>F(i).element===n);p.length!==0&&(m.push(e("tr",{className:"sb-variables-table__row-border",children:e("td",{colSpan:1+f.length,className:"sb-variables-table__cell--compact",children:e(u,{children:n})})},`element-divider-${a}-${n}`)),p.forEach(i=>{m.push(b(i)),o.delete(i)}))}Array.from(o).sort().forEach(n=>m.push(b(n)))}return m},g={tags:["!dev"],parameters:{docs:{description:{story:"Color themes are controlled by the `.figma-light` or `.figma-dark` classes provided by Figma in the plugin window.<br/> For FigJam, use the `.figjam` class on the plugin root (see `dist/themes.css`)."}}},render:()=>{const[r,l]=T({intents:{neutral:!0,"neutral-inverted":!0,"neutral-fixed":!0,"neutral-inverted-fixed":!0,brand:!0,danger:!0,warning:!0,success:!0,system:!0,shadow:!0},elements:{bg:!0,text:!0,icon:!0,border:!0},themes:{figmaLight:!0,figmaDark:!0,figjamLight:!0}});return e(S,{children:[e(C,{spacing:1e3,direction:"row",children:[e(C,{spacing:200,direction:"column",children:[e(u,{strong:!0,children:"Intents"}),Object.entries(r.intents).map(([t,c])=>e(h,{checked:c,label:t,onCheckedChange:d=>l({...r,intents:{...r.intents,[t]:d.checked}})},t))]}),e(C,{spacing:200,direction:"column",children:[e(u,{strong:!0,children:"Elements"}),Object.entries(r.elements).map(([t,c])=>e(h,{checked:c,label:t,onCheckedChange:d=>l({...r,elements:{...r.elements,[t]:d.checked}})},t))]}),e(C,{spacing:200,direction:"column",children:[e(u,{strong:!0,children:"Themes"}),Object.entries(r.themes).map(([t,c])=>e(h,{checked:c,label:t,onCheckedChange:d=>l({...r,themes:{...r.themes,[t]:d.checked}})},t))]})]}),e(j,{size:400}),e("div",{className:"sb-column sb-gap-16 sb-variables-table-wrap",children:e("table",{className:"sb-variables-table",children:[e("tr",{className:"sb-variables-table__row-border",children:[e("td",{className:"sb-variables-table__cell",children:e(u,{strong:!0,children:"Token name"})}),x.filter(t=>r.themes[t.key]).map(t=>e("td",{className:"sb-variables-table__cell",children:e(u,{strong:!0,children:t.label})},t.key))]}),M(r)]})})]})}};var A,E,k;g.parameters={...g.parameters,docs:{...(A=g.parameters)==null?void 0:A.docs,source:{originalSource:`{
  tags: ['!dev'],
  parameters: {
    docs: {
      description: {
...
}`,...(k=(E=g.parameters)==null?void 0:E.docs)==null?void 0:k.source}}};const Fe=["Colors"];export{g as Colors,Fe as __namedExportsOrder,de as default};
