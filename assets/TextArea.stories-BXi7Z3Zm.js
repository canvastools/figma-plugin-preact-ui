import{d as g,A as z,F as $e,_ as q,y as J,u as t}from"./hooks.module-CGIakYml.js";import{f as v}from"./index-BWINGljf.js";import{k as Be}from"./preact.module-C06nO-nz.js";import{t as Ye,b as Ge}from"./typedForwardRef-BtG8EZfd.js";import{T as xe}from"./Text-9aeIDhQ2.js";import{T as Ke,a as Xe}from"./TooltipContext-C-9LO0ZZ.js";import"./compat.module-DSB5hssq.js";import"./TooltipContainer-BVa1RtHA.js";const U=24;function I(n,s,r){return Math.min(r,Math.max(s,Math.round(n)))}function O(n){const s=getComputedStyle(n),r=parseFloat(s.minHeight),c=Number.isFinite(r)&&r>0?r:U,h=parseFloat(s.maxHeight),i=Number.isFinite(h)?Math.max(c,h):Number.MAX_SAFE_INTEGER;return{minPx:c,maxPx:i}}const je=({id:n,className:s,variant:r="default",label:c,placeholder:h,value:i,defaultValue:ve,error:we=!1,disabled:f=!1,minLength:Te=0,maxLength:Ve,tooltip:W,autoFocus:$=!1,selectOnFocus:Pe=!1,maxWidth:y,minHeight:d,maxHeight:u,resize:l,onValueChange:H,onBlur:L,onFocus:N,onKeyDown:E,tabIndex:B,...Ce},Ae)=>{const b=i!==void 0,[Y,Se]=g(()=>ve??""),[He,G]=g(!1),[Le,F]=g(!!(i??Y??"")),[Ne,K]=g(U),_=z(null),m=z(null),R=z(null);$e(Ae,()=>_.current,[]);const X=b?i??"":Y,Ee=l!=="y";q(()=>{if(l!=="y"||!m.current)return;const{minPx:e,maxPx:a}=O(m.current);K(p=>I(p,e,a))},[l,d,u]),q(()=>{const e=R.current,a=m.current;if(!e||!a)return;if(l==="y"){e.style.removeProperty("height");return}e.style.height="0px";const{minPx:p,maxPx:D}=O(a),M=I(e.scrollHeight,p,D);e.style.height=`${M}px`},[l,u,d,X]),J(()=>{if(!$)return;const e=window.setTimeout(()=>{var a;(a=R.current)==null||a.focus()},25);return()=>clearTimeout(e)},[$]),J(()=>{b&&i!==void 0&&F(i.length>0)},[b,i]);const Fe=Ge("TextArea",void 0,{filled:Le,disabled:f,variant:r,label:!!c,focused:He,error:we,resizeY:l==="y",autoGrow:Ee}),_e=e=>{if(f||l!=="y"||!m.current)return;e.preventDefault(),e.stopPropagation();const a=m.current,p=e.currentTarget,D=e.clientY,M=a.getBoundingClientRect().height,{minPx:Oe,maxPx:Ue}=O(a);p.setPointerCapture(e.pointerId);const j=k=>{const We=M+(k.clientY-D);K(I(We,Oe,Ue))},x=k=>{window.removeEventListener("pointermove",j),window.removeEventListener("pointerup",x),window.removeEventListener("pointercancel",x);try{p.releasePointerCapture(k.pointerId)}catch{}};window.addEventListener("pointermove",j),window.addEventListener("pointerup",x),window.addEventListener("pointercancel",x)},Re=e=>{e.stopPropagation();const a=e.currentTarget.value;b||Se(a),F(a.length>0),H==null||H({event:e,value:a})},De=e=>{e.stopPropagation(),G(!1),F(e.currentTarget.value.length>0),L==null||L({event:e,value:e.currentTarget.value})},Me=e=>{if(e.stopPropagation(),G(!0),Pe){const a=e.currentTarget;setTimeout(()=>a.select(),0)}N==null||N({event:e,value:e.currentTarget.value})},ke=e=>{e.stopPropagation(),E==null||E({event:e,value:e.currentTarget.value}),(e.key==="Escape"||e.key==="Esc")&&e.currentTarget.blur()},ze=e=>{e.stopPropagation()},Ie={maxWidth:r==="default"?void 0:typeof y=="number"?`${y}px`:y,flexShrink:y?0:void 0,minHeight:d!==void 0?typeof d=="number"?`${d}px`:d:l==="y"?`${U}px`:void 0,maxHeight:u!==void 0?typeof u=="number"?`${u}px`:u:void 0,height:l==="y"?`${Ne}px`:void 0};return t(Be,{children:[t("div",{id:n,className:[Fe,s].join(" ").trim(),"data-pui-interactive":"true",ref:_,...Ce,children:[c&&t(xe,{className:"TextArea__label",intentModifier:"secondary",size:r==="list"?"medium":"small",truncate:!0,children:c}),t("div",{className:"TextArea__container",style:Ie,ref:m,children:[t("textarea",{className:"TextArea__textarea-native",rows:1,ref:e=>{R.current=e},minLength:Te,maxLength:Ve,disabled:f,...B!==void 0?{tabIndex:B}:{},placeholder:h,value:X,onChange:Re,onClick:ze,onBlur:De,onFocus:Me,onKeyDown:ke}),l==="y"&&!f&&t("div",{className:"TextArea__resizeHandle","data-pui-interactive":"true",onPointerDown:_e})]})]}),W&&t(Ke,{anchorRef:_,children:W})]})},o=Ye(je),qe={parameters:{controls:{disable:!0},viewport:{defaultViewport:"large"},docs:{source:{language:"tsx",code:`
