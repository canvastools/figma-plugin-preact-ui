import{u as e,d}from"./hooks.module-6Sbq__eq.js";import{f as W}from"./index-B4E_jmCM.js";import{C as r}from"./ColorPicker-CHWBQKiq.js";import{T as i}from"./Text-BbQ_b1VF.js";import{a as N}from"./TooltipContext-DB8mQxid.js";import"./preact.module-gH5CyEHP.js";import"./compat.module-CHmB9zKI.js";import"./typedForwardRef-CtFJgl6m.js";import"./color-OwKICefG.js";import"./useStringInput-DXX1tuwF.js";import"./Select-C6ioo6oz.js";import"./Icon-C6_npEhI.js";import"./chevronDown-CECORTRu.js";import"./MenuContainer-D7I4Bl73.js";import"./chevronUp-CJIqewiB.js";import"./MenuDivider-AltCHnUL.js";import"./MenuItemOption--423OxRJ.js";import"./check-CPtlZW3F.js";import"./Input-yA2Ux4fx.js";import"./useNumericInput-DN6prgmR.js";import"./ControlGroup-DjwSP2yO.js";import"./TooltipContainer-CJCq4A9v.js";const U={parameters:{controls:{disable:!0},viewport:{defaultViewport:"large"},docs:{source:{language:"tsx",code:`
<ColorPicker 
  defaultColor={{ r: 1, g: 0, b: 0, a: 1 }}
  defaultType="hex"
/>
`}}},render:()=>e("div",{className:"sb-column sb-width-full sb-gap-16",children:e(r,{defaultColor:{r:1,g:0,b:0,a:1},defaultType:"hex"})})},O={parameters:{controls:{disable:!0},viewport:{defaultViewport:"large"},docs:{source:{language:"tsx",code:`
...
`}}},showControls:{control:{type:"boolean"},defaultValue:{summary:"true"}},alpha:{control:{type:"boolean"},defaultValue:{summary:"true"},description:"When false, hides hexAlpha mode and opacity controls in other modes."},width:{control:{type:"number"},defaultValue:{summary:"207"}},fullWidth:{control:{type:"boolean"},defaultValue:{summary:"false"},description:"Overrides `width` property."},tabIndex:{control:{type:"number"},description:"Tab order of the color picker root wrapper. Omit when it should not be in the tab sequence.",table:{type:{summary:"number"}}},onTypeChange:{table:{type:{summary:"(args) => void",detail:`
args:{
...
<ColorPicker {...args} />
`}}},render:t=>e("div",{className:"sb-column sb-width-full",children:e(N,{children:e(r,{...t})})})},l=U,s=O,n=D,p=_;var u,m,h;a.parameters={...a.parameters,docs:{...(u=a.parameters)==null?void 0:u.docs,source:{originalSource:`{
  tags: ['!autodocs'],
  args: {
    id: undefined,
    className: '',
