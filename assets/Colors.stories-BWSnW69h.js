import{n as e}from"./rolldown-runtime-DAXXjFlN.js";import{S as t,j as n,p as r,w as i}from"./compat.module-BbhDrffC.js";import{n as a,t as o}from"./jsxRuntime.module-B_u_rUE0.js";import{f as s}from"./utils-k8SxZ3Xg.js";import{t as c}from"./Text-Bf8YN4P6.js";import{c as l,o as u,t as d,u as f}from"./themes-CIcOshzH.js";import{$t as p,At as m,Vn as h,g,m as _,t as v,xn as y,zn as b}from"./src-nP44HpfJ.js";import{i as x,r as S,t as C}from"./utils-BpkYNFOU.js";function w(e,t=[]){let n={};for(let[r,i]of Object.entries(e)){let e=[...t,r];typeof i==`string`?n[e.join(`-`)]=i:typeof i==`object`&&i&&Object.assign(n,w(i,e))}return n}function T(e,t){let n={},r=new Set(Object.entries(e.intents).filter(([,e])=>e).map(([e])=>e)),i=new Set(Object.entries(e.elements).filter(([,e])=>e).map(([e])=>e));for(let[a,o]of Object.entries(t)){let t=w(o.variables);for(let[o,s]of Object.entries(t)){let t=o.split(`-`),c=t.findIndex(t=>t in e.elements),l=c>0?t.slice(0,c).join(`-`):t[0],u=c>0?t[c]:void 0;r.has(l)&&(u&&u in e.elements&&!i.has(u)||(n[o]||(n[o]={}),n[o][a]=s))}}let a=Object.keys(t);for(let e of Object.keys(n))for(let t of a)t in n[e]||(n[e][t]=void 0);return n}var E,D,O,k,A;e((()=>{r(),i(),d(),v(),x(),o(),E={title:`Variables/Colors`,parameters:{docs:{source:{code:`
// CSS
